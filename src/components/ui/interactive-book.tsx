                ...
                <div className="absolute inset-0 w-full h-full z-0" style={{ transformStyle: 'preserve-3d' }}>
                    ...
                    >
                        <div className="absolute inset-0 p-8 flex flex-col items-center justify-center text-center opacity-40">
                            <p className="font-serif text-neutral-500 italic mb-6">The End</p>

                            <div className="flex flex-col items-center gap-4">
                                <AnimatedButton
                                    onClick={() => window.location.href = 'testfirstpage.html'}
                                    className="px-8 py-3 bg-black dark:bg-black text-white font-bold rounded-full shadow-lg border border-white/10"
                                >
                                    LETS DO IT
                                </AnimatedButton>
                                ...
                                <button
                                    onClick={restartBook}
                                    className="flex items-center gap-2 px-4 py-2 rounded-full hover:bg-neutral-100 transition-colors text-xs text-neutral-400 cursor-pointer"
                                >
